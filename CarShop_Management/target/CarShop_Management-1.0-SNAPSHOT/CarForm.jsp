<%-- 
    Document   : CarForm
    Created on : 7 Jun 2024, 9:14:53 pm
    Author     : muhdi
--%>
        ...
        <div class="container col-md-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <fieldset class="form-group">
                        <label>Car Model</label><input type="text" value="<c:out value='${car.model}' />" class="form-control" name="model" required="required">
                    </fieldset>
                    
                    <fieldset class="form-group">
                        <label>Engine Cylinder</label><input type="text" value="<c:out value='${car.cylinder}' />" class="form-control" name="cylinder">
                    </fieldset>  
                                                           
                    <fieldset class="form-group">
                        <label>Car Price</label><input type="text" value="<c:out value='${car.price}' />" class="form-control" name="price">
                    </fieldset>
